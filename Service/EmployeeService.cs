...
internal sealed class EmployeeService : IEmployeeService
{
		...
		EmployeeForUpdateDto employeeForUpdate, bool compTrackChanges, bool empTrackChanges)
	{
		...
		Employee employeeForCompany = await GetEmployeeForCompanyAndCheckIfItExists(companyId, id, empTrackChanges);
	...
	public async Task<(EmployeeForUpdateDto employeeToPatch, Employee employeeEntity)> GetEmployeeForPatchAsync(Guid companyId, Guid id, bool compTrackChanges, bool empTrackChanges)
	{
		...
		Employee employeeEntity = await GetEmployeeForCompanyAndCheckIfItExists(companyId, id, compTrackChanges);
